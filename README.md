# HUS - تطبيق الدردشة الصوتية مع الوسائط المتقدمة

![HUS Logo](https://via.placeholder.com/200x100/6366f1/ffffff?text=HUS+v2.0)

[![Version](https://img.shields.io/badge/version-2.0.0-blue.svg)](https://github.com/sukkar007/tre/releases/tag/v2.0.0)
[![Flutter](https://img.shields.io/badge/Flutter-3.32.8-02569B.svg)](https://flutter.dev)
[![Node.js](https://img.shields.io/badge/Node.js-18+-339933.svg)](https://nodejs.org)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)

## 📱 نظرة عامة

**HUS v2.0** هو تطبيق دردشة صوتية متطور مع ميزات وسائط متقدمة، مبني باستخدام Flutter للواجهة الأمامية و Node.js للواجهة الخلفية. يوفر التطبيق تجربة ترفيهية تفاعلية مع إمكانيات تشغيل فيديوهات YouTube والملفات الصوتية المحلية مع مزامنة في الوقت الفعلي.

## 🎉 الجديد في الإصدار 2.0.0

### 🎵 تشغيل فيديوهات YouTube
- إضافة فيديوهات YouTube عبر الرابط مع التحقق التلقائي
- مزامنة التشغيل بين جميع المستخدمين في الوقت الفعلي
- أدوات تحكم متقدمة (تشغيل، إيقاف، تقديم، ترجيع)
- وضع ملء الشاشة مع تحكم كامل
- عرض معلومات الفيديو والقناة

### 🎶 تشغيل الملفات الصوتية المحلية
- رفع ملفات صوتية متعددة الأنواع (MP3, WAV, AAC, FLAC)
- مشغل صوتي احترافي مع واجهة أنيقة
- مصور صوتي متحرك مع تأثيرات بصرية
- أدوات تحكم متقدمة (سرعة، صوت، تكرار)
- معالجة ذكية لمعلومات الملفات

### 📱 نظام إدارة قائمة الانتظار المتقدم
- قائمة تشغيل ديناميكية مع ترتيب ذكي
- أوضاع خلط وتكرار متقدمة
- تاريخ التشغيل وإحصائيات الاستخدام
- قوائم تشغيل ذكية حسب الشعبية
